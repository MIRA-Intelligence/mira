...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install radiologybot-ai[matrix]"
    ) from e

from radiologybot.bus.events import OutboundMessage
from radiologybot.channels.base import BaseChannel
from radiologybot.config.paths import get_data_dir, get_media_dir
from radiologybot.utils.helpers import safe_filename
