...
from radiologybot.agent.tools.spawn import SpawnTool
...
from radiologybot.session.manager import Session, SessionManager

if TYPE_CHECKING:
    from radiologybot.config.schema import ChannelsConfig, ExecToolConfig
...
class AgentLoop:
    ...
    async def _connect_mcp(self) -> None:
        ...
        from radiologybot.agent.tools.mcp import connect_mcp_servers
        try:
