...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install mira[matrix]"
    ) from e

from mira_engine.bus.events import OutboundMessage
from mira_engine.channels.base import BaseChannel
from mira_engine.config.schema import MatrixConfig as _SchemaMatrixConfig
from mira_engine.config.paths import get_data_dir, get_media_dir
from mira_engine.utils.helpers import safe_filename
