...
from mira_engine.config.schema import DingTalkConfig
...
class MiraDingTalkHandler(CallbackHandler):
    ...
    async def process(self, message: CallbackMessage):
        ...
        try:
            ...
            # Forward to mira via _on_message (non-blocking).
...
class DingTalkChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        try:
            ...
            handler = MiraDingTalkHandler(self)
    ...
    async def _on_message(
        ...
        """Handle incoming message (called by MiraDingTalkHandler).
