"""JSON Schema fragment types: all subclass :class:`~mira_engine.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~mira_engine.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~mira_engine.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~mira_engine.agent.tools.base.Schema`.
...
from mira_engine.agent.tools.base import Schema
