...
from mira_engine.security.network import validate_url_target
...
def test_onboard_does_not_crash_with_legacy_memory_window(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("mira_engine.cli.commands.get_workspace_path", lambda _workspace=None: workspace)
