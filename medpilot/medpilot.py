"""High-level programmatic interface to medpilot."""
...
class MedPilot:
    """Programmatic facade for running the medpilot agent.
    ...
    def from_config(
        ...
        *,
        ...
        """Create a MedPilot instance from a config file.

        Args:
            config_path: Path to ``config.json``.  Defaults to
                ``~/.medpilot/config.json``.
            workspace: Override the workspace directory from config.
        """
        from medpilot.config.loader import load_config, resolve_config_env_vars
