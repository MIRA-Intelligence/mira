...
This directory contains built-in skills that extend medpilot's capabilities.
...
When skills reference large local documentation or logs, prefer medpilot's built-in
